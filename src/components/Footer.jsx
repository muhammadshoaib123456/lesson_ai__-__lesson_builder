...
//  * Footer
//  *
//  * A simple two-column footer with a logo and links on the left and social
//  * icons on the right. Preserves the styling of the original component and
//  * uses the same gradient background as the header.
//  */
// const Footer = () => {
//   return (
//     <>
...
//                 <img src="/OneScreen.svg" alt="OneScreen logo" className="h-full w-full object-contain" />
//               </div>
//             </div>
//             {/* Footer links */}
