 ...
 * Proxies to: POST https://builder.lessn.ai:8085/upload_slide?socketID=...
 * Upstream returns text (URL or "fail"); we return plain text too.
 */
export async function POST(request) {
  try {
    ...
    // Return plain text as the frontend expects .text()
