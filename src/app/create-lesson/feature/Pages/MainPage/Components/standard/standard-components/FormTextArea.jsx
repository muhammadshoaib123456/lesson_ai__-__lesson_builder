...
export function FormTextarea({
  ...
  return (
    <div className="mb-2 w-4/5">
      ...
      <textarea
        id={name}
        className={`text-base font-semibold rounded-3xl border w-full px-3 py-2 h-24 resize-none overflow-y-auto focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500
          ${error 
